...
face_classifier = cv2.CascadeClassifier(r'/home/david/Projects/ros2_ws/haarcascade_frontalface_default.xml')
classifier =load_model(r'/home/david/Projects/ros2_ws/model.h5')
...
class TelloRosWrapper(Node):
    ...
    def or_camera_image_callback(self) -> None:
